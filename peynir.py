...
# -*- coding: utf-8 -*-
#
#       peynir.py - Suprapackage Manager for Archlinux. It's also a framework for configuring Archlinux or other pacman based distributions.
#       
...
mirror = 'http://www.alansistem.com/peynir/' #Mirrorlist adlı bir dosya daha oluştr.
...
#bu ve altındaki fonksiyon log oluşturmak oluşturulan girdileri düzenlemek için, bunun internetten kaynağını bul ve refere et.
...
def install(source):
    ...
    for step in root[3]:
        ...
        try:
            ...
            #bu satıra gelecek kısım var!!!
            print("Error occureed in step of " + step)
            os.remove(sprcpkg_dir+source+" .xml")
            sys.exit(1)
